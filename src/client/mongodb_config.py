...
class MongoConfig:
    ...
    # 连接参数
    _max_pool_size = int(os.getenv("MONGO_MAX_POOL_SIZE", "100"))
    _connect_timeout = int(os.getenv("MONGO_CONNECT_TIMEOUT_MS", "5000"))  # 毫秒
    _socket_timeout = int(os.getenv("MONGO_SOCKET_TIMEOUT_MS", "3000"))  # 毫秒
